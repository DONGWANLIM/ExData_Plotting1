...
file_name <- "C:/Users/limdw/Downloads/Data Science - Foundations using R Specialization(Johns Hopkins University)/Course 4 - Exploratory Data Analysis/Week 1 course project 1/household_power_consumption.txt"
